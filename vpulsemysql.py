# -*- coding: utf-8 -*-
"""
Created on Mon Jan 27 18:01:11 2020
...
import time
def run():
    engine = sqlalchemy.create_engine("mysql+pymysql://root:Abc@1234@localhost:3306/second")
    rawdata = pd.read_sql_table("vpulse",engine)
    #print(rawdata)
...
#print(y_pred)
#print(z_pred)
    train_data = 100*(z_pred)
    test_data = 100*(y_pred)
